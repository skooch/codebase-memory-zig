...
pub const McpServer = struct {
    ...
    fn handleLine(self: *McpServer, line: []const u8) !?[]const u8 {
        ...
        if (std.mem.eql(u8, request.value.method, "tools/list")) {
            const payload =
                "{\"tools\":[" ++ "{\"name\":\"index_repository\",\"description\":\"Index a repository into the knowledge graph\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"repo_path\":{\"type\":\"string\",\"description\":\"Path to the repository\"},\"mode\":{\"type\":\"string\",\"enum\":[\"full\",\"moderate\",\"fast\"],\"default\":\"full\",\"description\":\"full: full discovery plus all current enrichment passes. moderate: fast discovery plus the current enrichment passes. fast: fast discovery without optional enrichment passes.\"}},\"required\":[\"repo_path\"]}}," ++ "{\"name\":\"search_graph\",\"description\":\"Structured graph search with filtering, degree-aware ranking, pagination, optional connected-node context, BM25 query search, and semantic keyword search\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"project\":{\"type\":\"string\"},\"query\":{\"type\":\"string\",\"description\":\"Natural-language or keyword full-text search using BM25 ranking over indexed project files. When this yields usable terms, name_pattern is ignored and the response includes search_mode:\\\"bm25\\\".\"},\"semantic_query\":{\"type\":\"array\",\"items\":{\"type\":\"string\"},\"description\":\"Array of keyword strings for semantic search (e.g. [\\\"send\\\",\\\"publish\\\"]). Results appear in semantic_results and require moderate/full indexing.\"},\"label\":{\"type\":\"string\"},\"label_pattern\":{\"type\":\"string\"},\"name_pattern\":{\"type\":\"string\"},\"qn_pattern\":{\"type\":\"string\"},\"file_pattern\":{\"type\":\"string\"},\"relationship\":{\"type\":\"string\"},\"exclude_entry_points\":{\"type\":\"boolean\"},\"include_connected\":{\"type\":\"boolean\"},\"limit\":{\"type\":\"number\"},\"offset\":{\"type\":\"number\"},\"min_degree\":{\"type\":\"number\"},\"max_degree\":{\"type\":\"number\"},\"sort_by\":{\"type\":\"string\"},\"sort_direction\":{\"type\":\"string\"}}}}," ++ "{\"name\":\"query_graph\",\"description\":\"Run a read-only Cypher-like query\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"project\":{\"type\":\"string\"},\"query\":{\"type\":\"string\"},\"max_rows\":{\"type\":\"number\"}}}}," ++ "{\"name\":\"trace_call_path\",\"description\":\"Trace call paths between nodes with configurable edge types, modes, risk labels, and test filtering\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"project\":{\"type\":\"string\"},\"start_node_qn\":{\"type\":\"string\",\"description\":\"Qualified name of start node\"},\"function_name\":{\"type\":\"string\",\"description\":\"Alias for start_node_qn (bare name lookup)\"},\"direction\":{\"type\":\"string\",\"enum\":[\"in\",\"out\",\"both\"]},\"depth\":{\"type\":\"number\"},\"mode\":{\"type\":\"string\",\"enum\":[\"calls\",\"data_flow\",\"cross_service\"],\"description\":\"Preset edge type set (default: calls)\"},\"edge_types\":{\"type\":\"array\",\"items\":{\"type\":\"string\"},\"description\":\"Explicit edge types override (takes priority over mode)\"},\"risk_labels\":{\"type\":\"boolean\",\"description\":\"Include hop-based risk classification per node\"},\"include_tests\":{\"type\":\"boolean\",\"description\":\"Include test-file nodes in results (default: false)\"}}}}," ++ "{\"name\":\"get_code_snippet\",\"description\":\"Read source code for a function/class/symbol. IMPORTANT: First call search_graph to find the exact qualified_name, then pass it here. This is a read tool, not a search tool. Accepts full qualified_name (exact match) or short function name (returns suggestions if ambiguous).\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"qualified_name\":{\"type\":\"string\",\"description\":\"Full qualified_name from search_graph, or short function name\"},\"project\":{\"type\":\"string\"},\"include_neighbors\":{\"type\":\"boolean\",\"default\":false}},\"required\":[\"qualified_name\",\"project\"]}}," ++ "{\"name\":\"get_graph_schema\",\"description\":\"Get the schema of the knowledge graph (node labels, edge types)\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"project\":{\"type\":\"string\"}},\"required\":[\"project\"]}}," ++ "{\"name\":\"get_architecture\",\"description\":\"High-level project summary: structure, dependencies, languages, hotspots, entry points, routes, and messaging\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"project\":{\"type\":\"string\"},\"aspects\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}}},\"required\":[\"project\"]}}," ++ "{\"name\":\"search_code\",\"description\":\"Text search across indexed project files with compact, full, or files-only output\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"project\":{\"type\":\"string\"},\"pattern\":{\"type\":\"string\"},\"mode\":{\"type\":\"string\",\"enum\":[\"compact\",\"full\",\"files\"]},\"file_pattern\":{\"type\":\"string\"},\"path_filter\":{\"type\":\"string\"},\"limit\":{\"type\":\"number\"},\"context\":{\"type\":\"number\"},\"regex\":{\"type\":\"boolean\"}},\"required\":[\"project\",\"pattern\"]}}," ++ "{\"name\":\"list_projects\",\"description\":\"List indexed projects\",\"inputSchema\":{\"type\":\"object\",\"properties\":{}}}," ++ "{\"name\":\"delete_project\",\"description\":\"Delete a project from the index\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"project\":{\"type\":\"string\"}},\"required\":[\"project\"]}}," ++ "{\"name\":\"index_status\",\"description\":\"Get the indexing status of a project\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"project\":{\"type\":\"string\"}}}}," ++ "{\"name\":\"detect_changes\",\"description\":\"Map local git changes to affected symbols and nearby blast radius\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"project\":{\"type\":\"string\"},\"base_branch\":{\"type\":\"string\"},\"since\":{\"type\":\"string\",\"description\":\"Git ref or date to compare from (e.g. HEAD~5, v0.5.0, 2026-01-01)\"},\"scope\":{\"type\":\"string\"},\"depth\":{\"type\":\"number\"}},\"required\":[\"project\"]}}," ++ "{\"name\":\"manage_adr\",\"description\":\"Create or update Architecture Decision Records\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"project\":{\"type\":\"string\"},\"mode\":{\"type\":\"string\",\"enum\":[\"get\",\"update\",\"sections\"]},\"content\":{\"type\":\"string\"},\"sections\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}}},\"required\":[\"project\"]}}," ++ "{\"name\":\"ingest_traces\",\"description\":\"Ingest runtime traces to enhance the knowledge graph\",\"inputSchema\":{\"type\":\"object\",\"properties\":{\"traces\":{\"type\":\"array\",\"items\":{\"type\":\"object\"}},\"project\":{\"type\":\"string\"}},\"required\":[\"traces\",\"project\"]}}" ++ "]}";
...
test "runFiles keeps tools/list on a single framed response line" {
    const allocator = std.testing.allocator;
    ...
    try stdin_writer.writeAll("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"initialize\",\"params\":{}}\n");
    try stdin_writer.writeAll("{\"jsonrpc\":\"2.0\",\"id\":2,\"method\":\"tools/list\",\"params\":{}}\n");
    stdin_writer.close();
    ...
    while (responses.next()) |line| {
        if (std.mem.trim(u8, line, " \r\t").len == 0) continue;
        non_empty_lines += 1;
    }

    try std.testing.expectEqual(@as(usize, 2), non_empty_lines);
}
