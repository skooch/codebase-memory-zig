...
## File Map
- Modify: `docs/plans/new/improvements/discovery-indexing-scope-and-query-semantics-improvements-plan.md`
- Create: `docs/plans/new/improvements/discovery-indexing-scope-and-query-semantics-improvements-progress.md`
...
- [ ] Capture the expected ignore semantics, search-only-indexed-files rule, schema-property expectations, and query-limit behavior in `docs/gap-analysis.md`.
- [ ] Add a local discovery-scope fixture with ignored, duplicated, and generated-style paths so search and schema behavior can be verified without external repos.
- [ ] Record exact `search_graph`, `search_code`, `get_graph_schema`, and `list_projects` verification commands in `docs/plans/new/improvements/discovery-indexing-scope-and-query-semantics-improvements-progress.md`.
- **Status:** pending
